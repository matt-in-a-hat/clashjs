export const lasers = {
  ...
  laser3: new Audio('assets/sounds/lasers/laser3.mp3'),
  laser4: new Audio('assets/sounds/lasers/laser4.mp3'),
  laser5: new Audio('assets/sounds/lasers/laser5.mp3'),
  laser6: new Audio('assets/sounds/lasers/laser6.mp3'),
  laser7: new Audio('assets/sounds/lasers/laser7.mp3'),
...
export const streak = {
  ...
  monsterKill: new Audio('assets/sounds/streak/monster-kill.mp3'),
  killingSpree: new Audio('assets/sounds/streak/killing-spree.mp3'),
  dominating: new Audio('assets/sounds/streak/dominating.mp3'),
  rampage: new Audio('assets/sounds/streak/rampage.mp3'),
  godLike: new Audio('assets/sounds/streak/god-like.mp3'),
